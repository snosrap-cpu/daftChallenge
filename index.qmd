...
pgm.add_node("node1", "Lemons", 1, 1, aspect=3.0, plot_params={'facecolor': 'yellow', 'edgecolor': 'orange', 'linewidth': 3})
pgm.add_node("node2", "Scurvy", 3, 1, aspect=3.0, plot_params={'facecolor': 'lightcoral', 'edgecolor': 'darkred', 'linewidth': 3}) 
...
```
**Reference Image:**
![](https://github.com/snosrap-cpu/daftChallenge/blob/main/index_files/figure-html/scurvy4.png)
...
pgm.add_node("node1", "Acid", 1, 3, aspect=3.0, plot_params={'facecolor': 'orange', 'edgecolor': 'darkorange', 'linewidth': 3})
pgm.add_node("node2", "Scurvy", 3, 1, aspect=3.0, plot_params={'facecolor': 'lightcoral', 'edgecolor': 'darkred', 'linewidth': 3})
pgm.add_node("node3", "Bacteria in Food", 2, 2, aspect=3.0, plot_params={'facecolor': 'lightgreen', 'edgecolor': 'darkgreen', 'linewidth': 3})

pgm.add_edge("node1", "node2")
pgm.add_edge("node1", "node3")
pgm.add_edge("node3", "node2")
...
```
**Reference Image:**
![](https://github.com/snosrap-cpu/daftChallenge/blob/main/index_files/figure-html/bacteria2.png)
...
pgm.add_node("node1", "Vitamin C", 1, 3, aspect=3.0, plot_params={'facecolor': 'orange', 'edgecolor': 'darkorange', 'linewidth': 3})
pgm.add_node("node2", "Scurvy", 3, 1, aspect=3.0, plot_params={'facecolor': 'lightcoral', 'edgecolor': 'darkred', 'linewidth': 3})
pgm.add_node("node3", "Collagen Synthesis", 2, 2, aspect=3.0, plot_params={'facecolor': 'lightgreen', 'edgecolor': 'darkgreen', 'linewidth': 3})
...
```
**Reference Image:**
![](https://github.com/snosrap-cpu/daftChallenge/blob/main/index_files/figure-html/collagen2.png)
